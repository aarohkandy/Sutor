...
export default function HomePage() {
  ...
  return (
    <main className="relative h-screen overflow-hidden bg-background px-6 py-6 text-foreground sm:px-10 sm:py-8">
      ...
      <div className={`relative z-10 mx-auto flex h-[calc(100vh-3rem)] max-w-6xl flex-col transition-opacity duration-300 sm:h-[calc(100vh-4rem)] ${ready ? "opacity-100" : "opacity-85"}`}>

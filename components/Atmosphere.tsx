...
const atmosphereThemes: Record<
  NonNullable<AtmosphereProps["variant"]>,
  {
    base: string;
    primary: string;
    secondary: string;
...
> = {
  home: {
    base: "radial-gradient(92rem 42rem at 50% 28%, rgba(248,248,246,0.12), rgba(248,248,246,0.04) 34%, rgba(10,10,10,0) 70%), linear-gradient(180deg, rgba(17,17,17,0.84) 0%, rgba(10,10,10,0.94) 44%, rgba(10,10,10,1) 100%)",
    primary:
  ...
  library: {
    base: "radial-gradient(64rem 44rem at 28% 20%, rgba(248,248,246,0.11), rgba(248,248,246,0.025) 36%, rgba(10,10,10,0) 70%), linear-gradient(180deg, rgba(17,17,17,0.86) 0%, rgba(10,10,10,0.96) 52%, rgba(10,10,10,1) 100%)",
    primary:
  ...
  record: {
    base: "radial-gradient(66rem 44rem at 50% 18%, rgba(248,248,246,0.09), rgba(248,248,246,0.02) 34%, rgba(10,10,10,0) 70%), linear-gradient(180deg, rgba(17,17,17,0.82) 0%, rgba(10,10,10,0.95) 42%, rgba(10,10,10,1) 100%)",
    primary:
    ...
    tertiary: "linear-gradient(180deg, rgba(248,248,246,0.02) 0%, rgba(248,248,246,0) 26%, rgba(248,248,246,0.02) 100%)"
  },
  results: {
    base: "radial-gradient(60rem 42rem at 50% 20%, rgba(248,248,246,0.11), rgba(248,248,246,0.03) 38%, rgba(10,10,10,0) 72%), linear-gradient(180deg, rgba(17,17,17,0.84) 0%, rgba(10,10,10,0.95) 46%, rgba(10,10,10,1) 100%)",
    primary:
  ...
  dialog: {
    base: "radial-gradient(44rem 30rem at 50% 26%, rgba(248,248,246,0.08), rgba(248,248,246,0.02) 38%, rgba(10,10,10,0) 74%), linear-gradient(180deg, rgba(10,10,10,0.84) 0%, rgba(10,10,10,0.92) 100%)",
    primary:
    ...
    secondary: "radial-gradient(36rem 24rem at 50% 76%, rgba(248,248,246,0.035), rgba(10,10,10,0) 78%)",
    tertiary: "linear-gradient(180deg, rgba(248,248,246,0.015) 0%, rgba(248,248,246,0) 100%)"
  }
};
...
export function Atmosphere({ variant = "home" }: AtmosphereProps) {
  ...
  return (
    <div aria-hidden="true" className="page-atmosphere">
      ...
      <div
        className="page-atmosphere__fog page-atmosphere__fog--secondary"
        style={{ backgroundImage: theme.secondary }}
      />
      <div
        className="page-atmosphere__fog page-atmosphere__fog--tertiary"
        style={{ backgroundImage: theme.tertiary }}
      />

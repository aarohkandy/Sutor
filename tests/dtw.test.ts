...
describe("dtw alignment", () => {
  test("keeps matching notes paired despite timing drift", () => {
    ...
    const actual: ActualNote[] = [
      { note: "C", octave: 4, cents_off: 4, start_ms: 30, duration_ms: 520, rms: 0.12, spectral_centroid: 900, hnr: 10 },
      { note: "D", octave: 4, cents_off: -6, start_ms: 570, duration_ms: 480, rms: 0.11, spectral_centroid: 910, hnr: 11 }
    ];
